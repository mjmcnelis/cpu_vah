...
#    '''
    ...
    dataDirAH = root + type + 'LO_t0-0.25_xi0-100_reg1-10_theta1p1'
    # VAH
    type = 'cpu-vah/1d/mcGlb/conformalEOS/'
    dataDirVAH = root + type + 't0-0.25_xi0-100_reg1-10_theta1p1'

    plotDir = 'tests/figs/proceedings'
...
#    plt.rcParams['axes.grid'] = 'False'
    ...
    ax.plot(xx, uxVH_noReg, color='green', linewidth=3.5, linestyle=':', label='VH')
    ...
    plt.ylabel(r'$u^x$')
    plt.title(r'$\tau=0.5\,\mathrm{fm/c}$',fontsize=16)
    ...
    ax.plot(xx, pratioVH_noReg, color='green', linewidth=3.5, linestyle=':', label='VH')
