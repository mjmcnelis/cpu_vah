...
#    '''
    ...
    # ptHat
    ptHatAH = (eAH-plAH-Rbar(eAH,pAH,plAH)*(eAH-3*pAH))/2
...
#    plt.rcParams['axes.grid'] = 'False'
    ...
    # a=pl/e
    fig, ax = plt.subplots()
    ax.plot(xx, 0.3333*np.ones((nxx,1)), color='black', linewidth=1.5, linestyle='-', label=r'$\xi\to 0$')
    ax.plot(xx, np.zeros((nxx,1)), color='black', linewidth=1.5, linestyle=':', label=r'$\xi\to\infty$')
    ax.plot(xx, np.divide(plAH,eAH), color='blue', linewidth=3.5, linestyle='--', label='AH')
    ax.plot(xx, np.divide(plVAH,eVAH), color='red', linewidth=3.5, linestyle='-.', label='VAH')
    ...
    plt.ylabel(r'$\hat{\mathcal{P}}_L/\mathcal{E}$')
...
#    plt.legend(loc='best', frameon=False)
    ...
    ax1.plot(xx, pittEnthalpyNormVH, color=colors[0], linewidth=3.5, linestyle='-', label=r'$\pi^{\tau\tau}$')
    ax1.plot(xx, pitxEnthalpyNormVH, color=colors[1], linewidth=3.5, linestyle='--', label=r'$\pi^{\tau x}$')
    ax1.plot(xx, pityEnthalpyNormVH, color=colors[2], linewidth=3.5, linestyle='--', label=r'$\pi^{\tau y}$')
    ax1.plot(xx, pixxEnthalpyNormVH, color=colors[3], linewidth=3.5, linestyle='--', label=r'$\pi^{xx}$')
    #first_legend = plt.legend(loc='lower left', frameon=False)
    #plt.gca().add_artist(first_legend)
    line1_5, = ax1.plot(xx, pixyEnthalpyNormVH, color=colors[4], linewidth=3.5, linestyle='--', label=r'$\pi^{xy}$')
    line1_6, = ax1.plot(xx, piyyEnthalpyNormVH, color=colors[5], linewidth=3.5, linestyle='--', label=r'$\pi^{yy}$')
    line1_7, = ax1.plot(xx, pinnEnthalpyNormVH, color=colors[6], linewidth=3.5, linestyle='--', label=r'$\tau^2\pi^{nn}$')
