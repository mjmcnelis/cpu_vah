...
precision t_200(precision z, precision t)
{
	if(z > delta)
	{
		return 1.0  +  (1.0 + z) * atan(sqrt(z)) / sqrt(z);
	}
	else if(z < - delta && z > -1.0)
	{
		return 1.0  +  (1.0 + z) * atanh(sqrt(-z)) / sqrt(-z);
	}
	else if(fabs(z) <= delta)
	{
		...
		return 2.0 + 0.6666666666666667*z - 0.1333333333333333*z2 + 0.05714285714285716*z3 - 0.031746031746031744*z4 +
   		0.020202020202020193*z5 - 0.013986013986013984*z6 + 0.010256410256410262*z7 - 0.00784313725490196*z8;
...
precision t_220(precision z, precision t)
{
	if(z > delta)
	{
		return (-1.0  +  (1.0 + z) * atan(sqrt(z)) / sqrt(z)) / z;
	}
	else if(z < - delta && z > -1.0)
	{
		return (-1.0  +  (1.0 + z) * atanh(sqrt(-z)) / sqrt(-z)) / z;
	}
	else if(fabs(z) <= delta)
	{
		precision z2  = z * z;
...
precision t_201(precision z, precision t)
{
	if(z > delta)
	{
		return (1.0  +  (z - 1.0) * atan(sqrt(z)) / sqrt(z)) / z;
	}
	else if(z < - delta && z > -1.0)
	{
		return (1.0  +  (z - 1.0) * atanh(sqrt(-z)) / sqrt(-z)) / z;
	}
	else if(fabs(z) <= delta)
	{
		precision z2  = z * z;
...
precision t_240(precision z, precision t)
{
	if(z > delta)
	{
		return (3.0  +  2.0 * z  -  3.0 * (1.0 + z) * atan(sqrt(z)) / sqrt(z)) / (z * z);
	}
	else if(z < - delta && z > -1.0)
	{
		return (3.0  +  2.0 * z  -  3.0 * (1.0 + z) * atanh(sqrt(-z)) / sqrt(-z)) / (z * z);
	}
	else if(fabs(z) <= delta)
	{
		precision z2  = z * z;
		...
		return 0.4 - 0.17142857142857149*z + 0.09523809523809523*z2 - 0.06060606060606058*z3 + 0.04195804195804195*z4 -
   		0.030769230769230785*z5 + 0.023529411764705882*z6 - 0.01857585139318886*z7 + 0.015037593984962405*z8;
...
precision t_221(precision z, precision t)
{
	if(z > delta)
	{
		...
		return (-3.0  +  (3.0 + z) * atan(sqrt(z)) / sqrt(z)) / (z * z);
	}
	else if(z < - delta && z > -1.0)
	{
		//return (-3.0  +  (3.0 + z) * t) / (z * z);

		return (-3.0  +  (3.0 + z) * atanh(sqrt(-z)) / sqrt(-z)) / (z * z);
	}
	else if(fabs(z) <= delta)
	{
		precision z2  = z * z;
		...
		return 0.2666666666666668 - 0.22857142857142854*z + 0.19047619047619047*z2 - 0.1616161616161616*z3 + 0.13986013986013987*z4 -
   		0.12307692307692308*z5 + 0.10980392156862744*z6 - 0.09907120743034055*z7 + 0.09022556390977443*z8;
